...
var d=r[n];
if(2==d.type){
if(2==i&&a==d.source_uin)continue;
t[d.img_url]={
...
m.innerHTML=TMPL.render("img_copyright_tpl",t[p]);
var c=m.children[0],_=d.parentNode,l=_.insertBefore(c,d),f=l.childNodes[0];
l.insertBefore(d,f);
}
}
}
...
var h=e("appmsg/review_image.js"),v=document.getElementById("js_cover"),b=[];
v&&b.push(v),new h({
container:document.getElementById("js_content"),
